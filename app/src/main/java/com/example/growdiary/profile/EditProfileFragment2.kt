...
class EditProfileFragment2 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_edit_profile2, container, false)

        // Inisialisasi semua view dengan ID yang telah diperbarui
        profileImage = view.findViewById(R.id.profile_image_edit2)
        btnEditPhoto = view.findViewById(R.id.btn_edit_photo2)
        textName = view.findViewById(R.id.text_name_edit2)
        btnEditName = view.findViewById(R.id.btn_edit_name2)
        autocompleteDay = view.findViewById(R.id.autocomplete_day2)
        autocompleteMonth = view.findViewById(R.id.autocomplete_month2)
        autocompleteYear = view.findViewById(R.id.autocomplete_year2)
        autocompleteGender = view.findViewById(R.id.autocomplete_gender2)
        editWeight = view.findViewById(R.id.edit_weight2)
        editHeight = view.findViewById(R.id.edit_height2)
        editNotes = view.findViewById(R.id.edit_notes2)
        btnSave = view.findViewById(R.id.btn_save_profile2)
